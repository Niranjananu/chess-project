...
[![Download chess-project](https://img.shields.io/badge/Download-chess--project-blue.svg)](https://github.com/Niranjananu/chess-project/releases)
...
## 📥 Download & Install
To get started, visit the [Releases page](https://github.com/Niranjananu/chess-project/releases) to download the latest version of the application. Follow these steps:

1. Go to the [Releases page](https://github.com/Niranjananu/chess-project/releases).
2. Locate the latest version listed at the top.
3. Find the appropriate file for your system. For most users, the file will be named `chess-project-latest.exe`.
4. Click on the file name to begin the download.

Once the download is complete:

1. Open the downloaded file (`chess-project-latest.exe`).
